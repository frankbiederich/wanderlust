		...
		1: [function(t, o, r) {
			! function(t, o) {
				...
				r.prototype.init = function() {
					...
					var o = 1,
						r = function t(o) {
							var r = e.core.outer.querySelector(".lg-current .lg-image"),
								i, a, l = (window.innerWidth - r.clientWidth) / 2,
					...
					for (var e = this, t = {}, o = {}, r = !1, i = !1, a = !1, l = 0, s, n = 0; n < e.core.___slide.length; n++) utils.on(e.core.___slide[n], "touchstart.lg", function(o) {
					...
					for (var u = 0; u < e.core.___slide.length; u++) utils.on(e.core.___slide[u], "touchmove.lg", function(n) {
						if (utils.hasClass(e.core.outer, "lg-zoomed")) {
					...
					for (var c = 0; c < e.core.___slide.length; c++) utils.on(e.core.___slide[c], "touchend.lg", function() {
					...
					for (var e = this, t = {}, o = {}, r = !1, i = !1, a = !1, l = !1, s = 0, n, u = 0; u < e.core.___slide.length; u++) utils.on(e.core.___slide[u], "mousedown.lgzoom", function(o) {
...
! function(e) {
	if ("object" == typeof exports && "undefined" != typeof module) module.exports = e();
		...
		var t;
		t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, t.LgHash = e()
	}
}(function() {
	var e, t, o;
	return function e(t, o, i) {
		...
		1: [function(t, o, i) {
			! function(t, o) {
				if ("function" == typeof e && e.amd) e([], o);
				else if ("undefined" != typeof i) o();
				else {
					var n = {
						exports: {}
					};
					o(), t.lgHash = n.exports
				}
			}(this, function() {
				"use strict";
				var e = Object.assign || function(e) {
					...
					o = function o(i) {
						return this.el = i, this.core = window.lgData[this.el.getAttribute("lg-uid")], this.core.s = e({}, t, this.core.s), this.core.s.hash && (this.oldHash = window.location.hash, this.init()), this
					};
				o.prototype.init = function() {
					var e = this,
						t;
					utils.on(e.core.el, "onAfterSlide.lgtm", function(t) {
						window.location.hash = "lg=" + e.core.s.galleryId + "&slide=" + t.detail.index
					}), utils.on(window, "hashchange.lghash", function() {
						t = window.location.hash;
						var o = parseInt(t.split("&slide=")[1], 10);
						t.indexOf("lg=" + e.core.s.galleryId) > -1 ? e.core.slide(o, !1, !1) : e.core.lGalleryOn && e.core.destroy()
					})
...
! function(e) {
	if ("object" == typeof exports && "undefined" != typeof module) module.exports = e();
		...
		var t;
		t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, t.LgAutoplay = e()
	}
}(function() {
	var e, t, o;
	return function() {
		function e(t, o, r) {
			...
			for (var l = "function" == typeof require && require, n = 0; n < r.length; n++) s(r[n]);
			return s
		}
		return e
	}()({
		1: [function(t, o, r) {
			! function(t, o) {
				...
				var e = Object.assign || function(e) {
					...
					o = function o(r) {
						return this.el = r, this.core = window.lgData[this.el.getAttribute("lg-uid")], !(this.core.items.length < 2) && (this.core.s = e({}, t, this.core.s), this.interval = !1, this.fromAuto = !0, this.canceledOnTouch = !1, this.fourceAutoplayTemp = this.core.s.fourceAutoplay, this.core.doCss() || (this.core.s.progressBar = !1), this.init(), this)
					};
				o.prototype.init = function() {
					var e = this;
					...
					utils.on(e.el, "onBeforeSlide.lgtm", function() {
						e.core.s.progressBar && e.fromAuto && (t = e.core.outer.querySelector(".lg-progress-bar"), o = e.core.outer.querySelector(".lg-progress"), e.interval && (o.removeAttribute("style"), utils.removeClass(t, "lg-start"), setTimeout(function() {
							utils.setVendor(o, "Transition", "width " + (e.core.s.speed + e.core.s.pause) + "ms ease 0s"), utils.addClass(t, "lg-start")
